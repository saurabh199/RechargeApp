 ...
 */
public class DthHandler extends SQLiteOpenHelper {
    ...
    // Contacts table name
    private static final String dth_OPERATOR = "operator";
    ...
    public DthHandler(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_CONTACTS_TABLE = "CREATE TABLE " + dth_OPERATOR + "("
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + dth_OPERATOR);
    ...
    // Adding new contact
    void adddthOperator(Dthoperator operator) {
        ...
        db.insert(dth_OPERATOR, null, values);
      //  System.out.println("" + values);
        db.close(); // Closing database connection
    }

    public static void adddthOperator(String operator, String opcode) {
    }
...
//
    ...
    public List<Dthoperator> getAllOperator() {
        List<Dthoperator> operatorList = new ArrayList<Dthoperator>();
        // Select All Query
        String selectQuery = "SELECT  * FROM " + dth_OPERATOR;
        ...
        if (cursor.moveToFirst()) {
            do {
                Dthoperator operator = new Dthoperator();
